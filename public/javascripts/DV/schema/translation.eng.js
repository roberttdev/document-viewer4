window.I18n.load({
  ...
  strings: {
    ...
    "next":"Next","next_note":"Next Annotation",
    "no_title_error":"Please enter a title.",
    "note":["Note","Notes"],
    "note_by":"Note by %s",
    "of":"of",
    ...
    "unsaved_data_error":"The latest graph data is unsaved.  Please export it from WebPlotDigitizer to continue.",
